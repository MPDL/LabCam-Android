...
public class TreeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            holder.itemView.setPaddingRelative((displayNodes.get(position).getHeight()+1) * padding, 3, 3, 3);
        }else {
            holder.itemView.setPadding((displayNodes.get(position).getHeight()+1) * padding, 3, 3, 3);
        }
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    selectedNode = displayNodes.get(holder.getLayoutPosition());
                }catch (Exception e){ }
    ...
    public OnTreeNodeListener getOnTreeNodeListener(){
        return onTreeNodeListener;
    }
    ...
    public void refreshChild(TreeNode selectedNode, RecyclerView.ViewHolder holder){
        // This TreeNode was locked to click.
        if (!selectedNode.isLeaf()) {
            if (onTreeNodeListener != null && holder != null){
